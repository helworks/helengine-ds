...
void ReferenceCanvasFitComponent::set_ReferenceWidth(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001F1 = "value";
auto __ctor_arg_000001F2 = "Reference canvas width must be at least one.";
return new ArgumentOutOfRangeException(__ctor_arg_000001F1, __ctor_arg_000001F2);
})();
    }
...
void ReferenceCanvasFitComponent::set_ReferenceHeight(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001F3 = "value";
auto __ctor_arg_000001F4 = "Reference canvas height must be at least one.";
return new ArgumentOutOfRangeException(__ctor_arg_000001F3, __ctor_arg_000001F4);
})();
    }
...
auto __ctor_arg_000001F5 = ::int2(static_cast<int32_t>(this->ReferenceWidthValue), static_cast<int32_t>(this->ReferenceHeightValue));
auto __ctor_arg_000001F6 = ::float2(0.0f, 0.0f);
return new ::AnchorSpace(__ctor_arg_000001F5, __ctor_arg_000001F6);
})();
...
const double liveHeight = mainWindowSize.Y > 0 ? mainWindowSize.Y : this->ReferenceHeightValue;
    ...
    {
return ([&]() {
auto __ctor_arg_000001F7 = static_cast<int32_t>(static_cast<int32_t>(Math::Round(liveWidth)));
auto __ctor_arg_000001F8 = static_cast<int32_t>(static_cast<int32_t>(Math::Round(liveHeight)));
return ::int2(__ctor_arg_000001F7, __ctor_arg_000001F8);
})();    }
