...
auto __ctor_arg_000001BA = "Refresh interval must be zero or greater.";
...
void FPSComponent::set_FontScale(float value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001BB = "value";
auto __ctor_arg_000001BC = "Font scale must be greater than zero.";
return new ArgumentOutOfRangeException(__ctor_arg_000001BB, __ctor_arg_000001BC);
})();
    }
