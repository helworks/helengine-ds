...
void TextComponent::set_FontScale(float value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000212 = "value";
auto __ctor_arg_00000213 = "Font scale must be greater than zero.";
return new ArgumentOutOfRangeException(__ctor_arg_00000212, __ctor_arg_00000213);
})();
    }
...
auto __ctor_arg_00000214 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(selectionWidth)));
auto __ctor_arg_00000215 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(lineHeight)));
return ::int2(__ctor_arg_00000214, __ctor_arg_00000215);
})());
this->SelectionSpriteValue->set_FillColor(::byte4(static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.X), static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.Y), static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.Z), static_cast<uint8_t>(96)));
this->SelectionSpriteValue->set_BorderColor(this->SelectionSpriteValue->FillColor);
}
