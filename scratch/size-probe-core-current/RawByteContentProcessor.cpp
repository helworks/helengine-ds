...
auto __usingDisposeGuard_000001CF = he_cpp_make_scope_exit([&]() {
...
return ([&]() {
auto __object_000001D0 = new ::RawByteContent();
__object_000001D0->set_Bytes(memoryStream->ToArray());
return __object_000001D0;
})();}
}
