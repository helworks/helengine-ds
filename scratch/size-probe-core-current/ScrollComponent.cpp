...
void ScrollComponent::set_Size(::int2 value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000202 = "value";
auto __ctor_arg_00000203 = "Scroll viewport size must not be negative.";
return new ArgumentOutOfRangeException(__ctor_arg_00000202, __ctor_arg_00000203);
})();
    }
...
void ScrollComponent::set_ItemCount(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000204 = "value";
auto __ctor_arg_00000205 = "Item count must be zero or greater.";
return new ArgumentOutOfRangeException(__ctor_arg_00000204, __ctor_arg_00000205);
})();
    }
...
void ScrollComponent::set_VisibleItemCount(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000206 = "value";
auto __ctor_arg_00000207 = "Visible item count must be zero or greater.";
return new ArgumentOutOfRangeException(__ctor_arg_00000206, __ctor_arg_00000207);
})();
    }
...
void ScrollComponent::set_ItemExtent(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000208 = "value";
auto __ctor_arg_00000209 = "Item extent must be at least one.";
return new ArgumentOutOfRangeException(__ctor_arg_00000208, __ctor_arg_00000209);
})();
    }
...
void ScrollComponent::set_ScrollStepCount(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000020A = "value";
auto __ctor_arg_0000020B = "Scroll step count must be at least one.";
...
void ScrollComponent::set_WheelNotchSize(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000020C = "value";
auto __ctor_arg_0000020D = "Wheel notch size must be at least one.";
...
::Entity* __coalesce_0000020E = this->ClipOriginEntityValue;
return __coalesce_0000020E != nullptr ? __coalesce_0000020E : this->Parent;
})();
