...
/// <summary>
/// Represents a lightweight four-value tuple for transpiled managed tuple flows.
/// </summary>
...
public:
    ...
    /// <param name="item2">Second tuple item.</param>
    /// <param name="item3">Third tuple item.</param>
    /// <param name="item4">Fourth tuple item.</param>
    ...
    /// <summary>
    /// Gets or sets the fourth tuple item.
    /// </summary>
    T4 Item4;
};
