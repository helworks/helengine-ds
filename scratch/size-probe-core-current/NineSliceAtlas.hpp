...
{
friend class NineSliceAtlas_Rect;
public:
...
private:
    static void Blit(Array<float>* src, int32_t srcW, int32_t srcH, ::NineSliceAtlas_Rect s, Array<uint8_t>* dst, int32_t dstW, int32_t dstH, ::NineSliceAtlas_Rect d);
