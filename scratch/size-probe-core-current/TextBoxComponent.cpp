...
auto __ctor_arg_0000020F = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(selectionWidth)));
auto __ctor_arg_00000210 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(lineHeight)));
return ::int2(__ctor_arg_0000020F, __ctor_arg_00000210);
})());
this->selectionSprite->set_FillColor(::byte4(static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.X), static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.Y), static_cast<uint8_t>(ThemeManager::get_Colors()->AccentPrimary.Z), static_cast<uint8_t>(96)));
}
...
auto __ctor_arg_00000211 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(textMetrics.Width)));
auto __ctor_arg_00000212 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(lineHeight)));
return ::int2(__ctor_arg_00000211, __ctor_arg_00000212);
})());
this->UpdateSelectionVisual(textY, lineHeight);
}
