...
void ButtonComponent::SetCornerRadius(float cornerRadius)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000213 = "cornerRadius";
auto __ctor_arg_00000214 = "Corner radius must not be negative.";
return new ArgumentOutOfRangeException(__ctor_arg_00000213, __ctor_arg_00000214);
})();
    }
...
void ButtonComponent::SetSize(::int2 newSize)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000215 = "newSize";
auto __ctor_arg_00000216 = "Button size must be positive.";
...
auto __ctor_arg_00000217 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(tight.Width)));
auto __ctor_arg_00000218 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(lineHeight)));
return ::int2(__ctor_arg_00000217, __ctor_arg_00000218);
})());
}
