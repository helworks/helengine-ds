...
auto __localDeleteGuard_000001D6 = he_cpp_make_scope_exit([&]() {
delete builder;
});
...
auto __object_000001D7 = new ::SceneMemoryProbeMeasurement();
__object_000001D7->set_ProbeName(this->ProbeName);
__object_000001D7->set_CycleIndex(this->CurrentCycleIndexValue);
__object_000001D7->set_StepIndex(this->CurrentStepIndexValue);
__object_000001D7->set_Label(step->Label);
__object_000001D7->set_ActionKind(step->ActionKind);
__object_000001D7->set_ResidentBytes(this->MemoryCountersValue->ResidentBytes);
__object_000001D7->set_CommittedBytes(this->MemoryCountersValue->CommittedBytes);
__object_000001D7->set_LoadedSceneIds(SceneMemoryProbeComponent::BuildLoadedSceneIds(sceneManager));
__object_000001D7->set_Drawables2DCount(objectManager == nullptr ? 0 : objectManager->Drawables2D->get_Count());
__object_000001D7->set_Drawables3DCount(objectManager == nullptr ? 0 : objectManager->Drawables3D->get_Count());
__object_000001D7->set_DrawCallCount(core->LastRenderManager3DDrawCallCount);
__object_000001D7->set_ActiveOwnedTextureCount(sceneManager == nullptr ? 0 : sceneManager->get_ActiveOwnedTextureReferenceCount());
__object_000001D7->set_ActiveOwnedFontCount(sceneManager == nullptr ? 0 : sceneManager->get_ActiveOwnedFontReferenceCount());
__object_000001D7->set_ActiveOwnedModelCount(sceneManager == nullptr ? 0 : sceneManager->get_ActiveOwnedModelReferenceCount());
__object_000001D7->set_ActiveOwnedMaterialCount(sceneManager == nullptr ? 0 : sceneManager->get_ActiveOwnedMaterialReferenceCount());
return __object_000001D7;
})();
