...
MouseState::MouseState() : _x(0), _y(0), _scrollWheelValue(0), _horizontalScrollWheelValue(0), _buttons()
{
}
...
{
return ::int2(static_cast<int32_t>(this->_x), static_cast<int32_t>(this->_y));}
...
MouseState::MouseState(int32_t x, int32_t y, int32_t scrollWheel, ::ButtonState leftButton, ::ButtonState middleButton, ::ButtonState rightButton, ::ButtonState xButton1, ::ButtonState xButton2) : _x(0), _y(0), _scrollWheelValue(0), _horizontalScrollWheelValue(0), _buttons()
{
this->_x = x;
this->_y = y;
...
MouseState::MouseState(int32_t x, int32_t y, int32_t scrollWheel, ::ButtonState leftButton, ::ButtonState middleButton, ::ButtonState rightButton, ::ButtonState xButton1, ::ButtonState xButton2, int32_t horizontalScrollWheel) : _x(0), _y(0), _scrollWheelValue(0), _horizontalScrollWheelValue(0), _buttons()
{
this->_x = x;
this->_y = y;
this->_scrollWheelValue = scrollWheel;
...
return String::Concat("[MouseState X=", std::to_string(this->_x), ", Y=", std::to_string(this->_y), ", Buttons=", buttons, ", Wheel=", std::to_string(this->_scrollWheelValue), ", HWheel=", std::to_string(this->_horizontalScrollWheelValue), "]");}
