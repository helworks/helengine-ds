...
void DebugComponent::set_RefreshIntervalSeconds(double value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000224 = "value";
auto __ctor_arg_00000225 = "Refresh interval must be zero or greater.";
return new ArgumentOutOfRangeException(__ctor_arg_00000224, __ctor_arg_00000225);
})();
    }
...
void DebugComponent::set_FontScale(float value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000226 = "value";
auto __ctor_arg_00000227 = "Font scale must be greater than zero.";
return new ArgumentOutOfRangeException(__ctor_arg_00000226, __ctor_arg_00000227);
})();
    }
...
void DebugComponent::ClearAdditionalLine(std::string id)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000228 = "Additional debug line id must be provided.";
auto __ctor_arg_00000229 = "id";
return new ArgumentException(__ctor_arg_00000228, __ctor_arg_00000229);
})();
    }
...
void DebugComponent::SetAdditionalLine(std::string id, std::string text)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000022A = "Additional debug line id must be provided.";
auto __ctor_arg_0000022B = "id";
return new ArgumentException(__ctor_arg_0000022A, __ctor_arg_0000022B);
})();
    }
else {
