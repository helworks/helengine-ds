...
void ViewportComponent::set_ReferenceWidth(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000216 = "value";
auto __ctor_arg_00000217 = "Reference width must be at least one.";
return new ArgumentOutOfRangeException(__ctor_arg_00000216, __ctor_arg_00000217);
})();
    }
...
void ViewportComponent::set_ReferenceHeight(int32_t value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000218 = "value";
auto __ctor_arg_00000219 = "Reference height must be at least one.";
return new ArgumentOutOfRangeException(__ctor_arg_00000218, __ctor_arg_00000219);
})();
    }
...
return ([&]() {
auto __ctor_arg_0000021A = static_cast<int32_t>(Math::Max(static_cast<int32_t>(1), static_cast<int32_t>(static_cast<int32_t>(Math::Round(viewport.Z)))));
auto __ctor_arg_0000021B = static_cast<int32_t>(Math::Max(static_cast<int32_t>(1), static_cast<int32_t>(static_cast<int32_t>(Math::Round(viewport.W)))));
return ::int2(__ctor_arg_0000021A, __ctor_arg_0000021B);
})();}
...
auto __ctor_arg_0000021C = ::int2(static_cast<int32_t>(this->ReferenceWidthValue), static_cast<int32_t>(this->ReferenceHeightValue));
auto __ctor_arg_0000021D = ::float2(0.0f, 0.0f);
return new ::AnchorSpace(__ctor_arg_0000021C, __ctor_arg_0000021D);
})();
this->CurrentViewportAnchorSpaceValue = ([&]() {
auto __ctor_arg_0000021E = ::int2(static_cast<int32_t>(this->ReferenceWidthValue), static_cast<int32_t>(this->ReferenceHeightValue));
auto __ctor_arg_0000021F = ::float2(0.0f, 0.0f);
return new ::AnchorSpace(__ctor_arg_0000021E, __ctor_arg_0000021F);
})();
...
return ([&]() {
auto __ctor_arg_00000220 = static_cast<int32_t>(Math::Max(static_cast<int32_t>(1), static_cast<int32_t>(static_cast<int32_t>(Math::Round(viewport.Z)))));
auto __ctor_arg_00000221 = static_cast<int32_t>(Math::Max(static_cast<int32_t>(1), static_cast<int32_t>(static_cast<int32_t>(Math::Round(viewport.W)))));
return ::int2(__ctor_arg_00000220, __ctor_arg_00000221);
})();}
...
const double liveHeight = viewportBounds.Y > 0 ? viewportBounds.Y : this->ReferenceHeightValue;
    ...
    {
return ([&]() {
auto __ctor_arg_00000222 = static_cast<int32_t>(static_cast<int32_t>(Math::Round(liveWidth)));
auto __ctor_arg_00000223 = static_cast<int32_t>(static_cast<int32_t>(Math::Round(liveHeight)));
return ::int2(__ctor_arg_00000222, __ctor_arg_00000223);
})();    }
