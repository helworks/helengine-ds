...
void ComboBoxComponent::set_Size(::int2 value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001E1 = "value";
auto __ctor_arg_000001E2 = "ComboBox size must be positive.";
return new ArgumentOutOfRangeException(__ctor_arg_000001E1, __ctor_arg_000001E2);
})();
    }
this->size = value;
...
ComboBoxComponent::ComboBoxComponent(::int2 size, ::FontAsset* font, List<std::string>* items, int32_t selectedIndex) : SelectionChanged(), FocusGroup(), TabIndex(0), IsDefaultTarget(), IsKeyboardFocused(), items(), itemVisuals(), hasRenderOrderOverrides(), font(), size(), itemHeight(0), selectedIndex(0), isOpen(), isHovering(), isPressed(), background(), labelText(), arrowText(), interactable(), labelEntity(), arrowEntity(), listRoot(), listBackground(), backgroundOrder(), textOrder(), listBackgroundOrder(), listTextOrder()
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001E3 = "size";
auto __ctor_arg_000001E4 = "ComboBox size must be positive.";
return new ArgumentOutOfRangeException(__ctor_arg_000001E3, __ctor_arg_000001E4);
})();
    }
else {
    if (font == nullptr)
...
auto __ctor_arg_000001E5 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(itemMetrics.Width)));
auto __ctor_arg_000001E6 = static_cast<int32_t>(static_cast<int32_t>(Math::Ceiling(Math::Max(static_cast<double>(itemMetrics.get_Height()), 1.0))));
return ::int2(__ctor_arg_000001E5, __ctor_arg_000001E6);
})());
...
for (int32_t i = 0; i < items->get_Count(); i++) {
    ...
    {
throw ([&]() {
auto __ctor_arg_000001E7 = "ComboBox items must not contain null entries.";
auto __ctor_arg_000001E8 = "items";
...
int32_t ComboBoxComponent::ValidateSelectedIndex(int32_t itemCount, int32_t index)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001E9 = "index";
auto __ctor_arg_000001EA = "SelectedIndex must be -1 or within the item range.";
return new ArgumentOutOfRangeException(__ctor_arg_000001E9, __ctor_arg_000001EA);
})();
    }
return index;}
