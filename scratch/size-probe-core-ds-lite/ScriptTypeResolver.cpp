...
void ScriptTypeResolver::Register(std::string moduleId, Assembly* assembly)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001CF = "Module id must be provided.";
auto __ctor_arg_000001D0 = "moduleId";
return new ArgumentException(__ctor_arg_000001CF, __ctor_arg_000001D0);
})();
    }
    if (assembly == nullptr)
    {
...
Type* ScriptTypeResolver::Resolve(std::string assemblyQualifiedTypeName)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000001D1 = "Assembly-qualified type name must be provided.";
auto __ctor_arg_000001D2 = "assemblyQualifiedTypeName";
