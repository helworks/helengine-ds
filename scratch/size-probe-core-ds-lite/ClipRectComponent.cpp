...
void ClipRectComponent::set_Size(::int2 value)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000210 = "value";
auto __ctor_arg_00000211 = "Clip rectangle size must not be negative.";
return new ArgumentOutOfRangeException(__ctor_arg_00000210, __ctor_arg_00000211);
})();
    }
