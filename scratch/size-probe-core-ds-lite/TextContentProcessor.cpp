...
auto __usingDisposeGuard_000001D3 = he_cpp_make_scope_exit([&]() {
if (reader != nullptr) {
reader->Dispose();
delete reader;
}
...
return ([&]() {
auto __object_000001D4 = new ::TextContent();
__object_000001D4->set_Text(reader->ReadToEnd());
return __object_000001D4;
})();}
}
